...
%
Both alleles were present in \textit{An. gambiae} populations sampled from Cameroon and Gabon, including some individuals with a hybrid \texttt{L995F/S} genotype (50/275 individuals in Cameroon, 41/56 in Gabon).
%
In Cameroon these alleles were in Hardy Weinberg equilibrium ($\chi^{2}$ = 0.02, P > 0.05 @@REDO), but there was an excess of heterozygotes in Gabon ($\chi^{2}$ = 8.96, P < 0.005 @REDO), suggesting a fitness advantage for mosquitoes carrying both alleles at least in some circumstances.
%%
