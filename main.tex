...
%
All variants are at 5\% frequency or above in one or more of the 16 Ag1000G phase 2 populations, with the exception of \texttt{2,400,071 G>T} which is only found in the CM\emph{Ag} population at 0.3\% frequency but is included because another mutation (\texttt{2,400,071 G>A}) found at the same position causing the same amino acid substitution (\texttt{M490I} is at >5\%).
}
...
%
This included individuals with a hybrid \texttt{L995F/S} genotype (50/297 individuals in Cameroon, 41/69 in Gabon), hinting there may be a fitness advantage for mosquitoes carrying both alleles in some circumstances.
%
%In Cameroon these alleles were in Hardy Weinberg equilibrium ($\chi^{2}$ = 0.02, P > 0.05 @@REDO), but there was an excess of heterozygotes in Gabon ($\chi^{2}$ = 8.96, P < 0.005 @@REDO with phase 2 and reincorporate into text? Unclear if it is possible to do hardy weinberg here - two locus, selection...), 
%%
...
%
This contrast was highly significant when data on all variants within the gene were considered: relative to haplotypes carrying the wild-type \texttt{L995} allele, the ratio of non-synonymous to synonymous nucleotide diversity @@REDO_for_phase_2 ($\pi_{N}/\pi_{S}$) was 28.1 (95\% CI [25.2, 31.2]) times higher among haplotypes carrying \texttt{L995F} but 1.5 (95\% CI [0.8, 2.2]) times higher among haplotypes carrying \texttt{L995S}.
%
...
%
Secondary substitutions have occurred and risen in frequency, suggesting that purifying selection they are providing some selective advantage in the presence of insecticide pressure.
%%
